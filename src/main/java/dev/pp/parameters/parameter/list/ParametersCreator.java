...
import dev.pp.parameters.textParameter.TextParameter;
import dev.pp.parameters.textParameter.TextParameters;
...
public class ParametersCreator {
    ...
    */
    ...
    public static @Nullable <T> Parameters<T> createFromTextParameters (
        @Nullable TextParameters textParameters,
    ...
    public static <T> boolean checkInvalidParameters (
        ...
        for ( String name : remainingNames ) {
            TextParameter parameter = textParameters.get ( name );
    ...
    private static <T> Parameter<T> getParameterForFormalParameter (
        ...
        TextParameter textParameter = getTextParameterForFormalParameter (
    ...
    private static TextParameter getTextParameterForFormalParameter (
        @Nullable TextParameters textParameters,
        ...
        for ( String name : formalParameter.getAllNames() ) {
            TextParameter parameter = textParameters.getIfContained ( name );
            if ( parameter != null ) {
